  ...
  return (
    <>
      <div className="bg-gray-100">
        <header className="fixed top-0 z-30 w-full px-4 py-4 lg:px-2 lg:py-2 bg-white border-b">
          <div className="flex items-center justify-between mx-auto max-w-7xl">
            {/* Logo & Navs  */}
            <div className="flex items-center">
              <Link href="/">
                <div className="flex items-center ml-4 lg:ml-8 xl:ml-8 cursor-pointer">
                  <Image
                    src="/images/logo.svg"
                    alt="Noze"
                    width="108"
