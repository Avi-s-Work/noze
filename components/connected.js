...
export default function Connected() {
  ...
  return (
    <>
      <div ref={ref} className="w-full h-screen border-t border-white relative">
        <motion.h1
          animate={animation}
          className="mt-24 text-5xl text-slate-900 font-bold text-center"
        >
          Stay connected with NOZE
        </motion.h1>
        <motion.p
          animate={animation}
          className="pt-6 pb-12 text-gray-600 text-center"
        >
        ...
        <div className="flex justify-center">
          ...
          <div>
            <label
              htmlFor="my-modal-3"
              className="bg-purple-700 hover:bg-purple-800 duration-300 text-white text-sm py-3 px-4 rounded-md hidden lg:flex justify-center border-0 modal-button cursor-pointer"
            >
